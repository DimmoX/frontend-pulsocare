...
import { lucideHeartHandshake, lucideScrollText, lucideUsersRound } from '@ng-icons/lucide';

@Component({
  selector: 'app-admin-tabs',
  imports: [RouterLink, RouterLinkActive, NgIcon],
  viewProviders: [provideIcons({ lucideUsersRound, lucideHeartHandshake, lucideScrollText })],
  template: `
